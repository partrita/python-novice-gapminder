[![우리와 함께 Slack 계정 만들기](https://img.shields.io/badge/Create_Slack_Account-The_Carpentries-071159.svg)](https://slack-invite.carpentries.org/)
[![Slack 상태](https://img.shields.io/badge/Slack_Channel-swc--py--gapminder-E01563.svg)](https://carpentries.slack.com/messages/C9X4W03KL)
...
플로팅과 데이터 분석에 중점을 둔 비프로그래머를 위한 파이썬 입문.
이 자료의 렌더링된 버전은 [https://swcarpentry.github.io/python-novice-gapminder/](https://swcarpentry.github.io/python-novice-gapminder/)를 참조하십시오.
수업 자료의 서식 지정 및 빌드에 대한 지침은 [수업 템플릿 문서][sandpaper-docs]를 참조하십시오.
